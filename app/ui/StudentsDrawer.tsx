  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-24 left-4 z-30 flex h-12 w-12 items-center justify-center rounded-full transition active:scale-90 lg:hidden"
      ...
      {open && (
        ...
        >
          <div
            className="absolute left-0 top-0 h-full w-72 max-w-[85vw] overflow-y-auto p-4 slide-up"
