...
import { Geist_Mono, Patrick_Hand, Caveat } from "next/font/google";
import "./globals.css";
import ServiceWorkerRegister from "./ServiceWorkerRegister";

// Hand-drawn sketch type drives both themes; mono is kept for codes/timers.
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html
      ...
      className={`${geistMono.variable} ${sketch.variable} ${sketchDisplay.variable} h-full antialiased`}
    >
      <head>
